<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"G:\Git\model\web/../app/admin\view\index_user.html";i:1477015709;s:50:"G:\Git\model\web/../app/all/view/index_layout.html";i:1476756500;s:50:"G:\Git\model\web/../app/all/view/index_header.html";i:1478823866;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    $(function(){
        $('#dg').datagrid({
            ...
            url:'<?php echo $ROOT; ?>/admin/user/query',toolbar:'#toolbar',
            columns:[[
            ...
            {field:'sex',title:'性别*',width:40,align:'center', editor:{type:'combobox', options:{url:'<?php echo $ROOT; ?>/all/option/sex',valueField:'sex',textField:'name',panelHeight:'auto',required:true,
            ...
            {field:'school',title:'学院*',width:100,align:'center', editor:{type:'combobox', options:{url:'<?php echo $ROOT; ?>/all/option/school',valueField:'school',textField:'name',panelWidth:'120',required:true,
                onSelect:function(rec) {
                    var tt=$('#dg');
        ...
        $('#dg2').datagrid({
            ...
            url:'<?php echo $ROOT; ?>/admin/user/role',toolbar:'#toolbar2',
            columns:[[
        ...
        $("#save,#menu_save").click(function(){
            ...
            $.post('<?php echo $ROOT; ?>/admin/user/update',effectRow,function(result){
                if (result.status==1){
        ...
        $("#save2,#menu2_save").click(function(){
            ...
            $.post('<?php echo $ROOT; ?>/admin/user/updaterole',{username:userName,role:roles},function(result){
                if (result.status==1){
                    tt.datagrid('acceptChanges');
                    tt.datagrid('reload');
                    $.messager.show({	// show error message
        ...
        $("#menu_changepassword,#changepassword").click(function(){
            ...
            $.messager.prompt('修改', '请输入新密码:', function(data){
                if (data){
                    $.post('<?php echo $ROOT; ?>/admin/user/changepassword',{teacherno:row.teacherno,password:data},function(result){
                        if (result.status==1){
                            $.messager.show({	// show error message
                                title: '成功',
                                msg: result.info
        ...
        $('#school').combobox({
            url:'<?php echo $ROOT; ?>/all/option/school?only=0',
            valueField:'school',
            textField:'name'
        });
