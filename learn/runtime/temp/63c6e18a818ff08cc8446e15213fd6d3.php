<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"G:\Git\model\web/../app/admin\view\index_school.html";i:1477014432;s:50:"G:\Git\model\web/../app/all/view/index_layout.html";i:1476756500;s:50:"G:\Git\model\web/../app/all/view/index_header.html";i:1476756500;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    $(function(){
        $('#dg').datagrid({
            ...
            url:'<?php echo $ROOT; ?>/admin/school/query',toolbar:'#toolbar',
            columns:[[
                ...
                {field:'active',title:'在用*',width:40,align:'center',editor:{type:'checkbox',options:{on:1,off:0}},
        ...
        $("#menu_save,#save").click(function(){
            ...
            $.post('<?php echo $ROOT; ?>/admin/school/update',effectRow,function(result){
                if (result.status==1){
